/*  T02: Collaboration Teamwork
    ...
    Edits made by:
     <Baella Morgan> -- to be added by student 1
     Langston Hill -- to be added by student 2
     <Mathewos> -- to be added by student 3 (if relevant otherwise, student 2 should remove this line)
 */
#include <iostream>
using namespace std;
